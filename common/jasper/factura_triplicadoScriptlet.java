...
public class  factura_triplicadoScriptlet extends it.businesslogic.ireport.IReportScriptlet {
   private final String[] UNIDADES = {"", "un ", "dos ", "tres ", "cuatro ", "cinco ", "seis ", "siete ", "ocho ", "nueve "};
     ...
     */
    public factura_triplicadoScriptlet() {
    }
...
/* funciones para convertir los numeros a literales */
    ...
    private String getMillones(String numero) { //000 000 000        
        ...
        String n = "";
	int million = Integer.parseInt(millon);
        if(million>1){
